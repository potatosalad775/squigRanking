...
- **CrinGraph parallel.** The CrinGraph equivalent is `ranking_url` in `config.js`. Same placeholder tokens, different casing. See [INTEGRATION-CRINGRAPH.md](INTEGRATION-CRINGRAPH.md).
