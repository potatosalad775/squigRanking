...
(function() {
	...
	function setConfig(next) {
		...
		if (declared !== void 0 && declared > 4) console.warn(`[squigRanking] ranking-config.js declares configVersion ${declared}, but this core understands 4. Update core.js.`);
	}
	function getConfig() {
		return config;
	}
	...
	*/
	function toggleLanguageLabel(lang) {
