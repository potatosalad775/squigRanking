...
export const llmsTxtConfig: LlmsTxtOptions = {
	...
	details: [
		...
		'  badge link in CrinGraph or modernGraphTool, or pointing modernGraphTool at the same',
		'  sheet so it shows grades from it.',
		...
		'  turns a CrinGraph or modernGraphTool `phone_book.json` into starting rows for the sheet.',
