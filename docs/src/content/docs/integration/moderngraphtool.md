...
- **CrinGraph parallel.** The CrinGraph equivalent is `ranking_url` in `config.js`. Same placeholder tokens, different casing. See [the CrinGraph guide](/integration/cringraph/).
